<aside class="border-end sticky-top" style="width: 12%; height: 100vh; margin-right:0px;">
    ...
    <div id="menu_sidebar" class="container mt-3" >
        ...
        <a href="?module=categories" id="cate" class="btn w-100 mb-2" style="text-align: left;">&emsp;&emsp;<i class="fa-solid fa-fire"></i>&emsp;Categories</a>
        <a href="?module=products" id="prd" class="btn w-100 mb-2" style="text-align: left;">&emsp;&emsp;<i class="fa-brands fa-dribbble"></i>&emsp;Products</a>
        <a href="?module=comments" id="cmt" class="btn w-100 mb-2" style="text-align: left;">&emsp;&emsp;<i class="fa-regular fa-comment"></i>&emsp;Comments</a>
